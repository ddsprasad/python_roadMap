...
print(getMiddleThreeChar("JhonDipPeta"))
print(getMiddleThreeChar("JaSonAy"))
...
def lowerAnduppersort(str1):
    ...
    for i in str1:
        if i.islower():
            lowStrings = lowStrings+i
        else:
            upStrings = upStrings+i

    return lowStrings+upStrings
